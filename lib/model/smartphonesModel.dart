...
//
//     final productSmartphoneModel = productSmartphoneModelFromJson(jsonString);

import 'dart:convert';

ProductSmartphoneModel productSmartphoneModelFromJson(String str) =>
    ProductSmartphoneModel.fromJson(json.decode(str));

String productSmartphoneModelToJson(ProductSmartphoneModel data) =>
    json.encode(data.toJson());

class ProductSmartphoneModel {
  List<Product>? products;
  int? total;
  int? skip;
  int? limit;

  ProductSmartphoneModel({
    this.products,
    this.total,
    this.skip,
    this.limit,
  ...
  factory ProductSmartphoneModel.fromJson(Map<String, dynamic> json) =>
      ProductSmartphoneModel(
