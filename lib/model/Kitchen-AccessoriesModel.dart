...
//
//     final productkitchenAccessoriesModel = productkitchenAccessoriesModelFromJson(jsonString);

import 'dart:convert';

ProductkitchenAccessoriesModel productkitchenAccessoriesModelFromJson(
        String str) =>
    ProductkitchenAccessoriesModel.fromJson(json.decode(str));

String productkitchenAccessoriesModelToJson(
        ProductkitchenAccessoriesModel data) =>
    json.encode(data.toJson());

class ProductkitchenAccessoriesModel {
  List<Product>? products;
  int? total;
  int? skip;
  int? limit;

  ProductkitchenAccessoriesModel({
    this.products,
    this.total,
    this.skip,
    this.limit,
  ...
  factory ProductkitchenAccessoriesModel.fromJson(Map<String, dynamic> json) =>
      ProductkitchenAccessoriesModel(
...
enum Category { KITCHEN_ACCESSORIES }

final categoryValues =
    EnumValues({"kitchen-accessories": Category.KITCHEN_ACCESSORIES});
